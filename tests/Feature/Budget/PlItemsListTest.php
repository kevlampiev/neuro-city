...
class plItemsListTest extends TestCase
{
     ...
     */
    public function testVisitplItemsListAsGuest(): void
    {
     ...
     */
    public function testVisitplItemsListAsNewSuperuser(): void
    {
    ...
    public function testVisitCFSItemsListAsProperUser(): void
    {
        ...
        ->assertSee('Группы статей PL')
        ->assertSee('Выручка')
        ->assertSee('Себестоимость')
        ->assertSee('Валовая прибыль')
        ->assertSee('Косвенные расходы')
        ->assertSee('EBITDA')
        ->assertSee('Амортизация')

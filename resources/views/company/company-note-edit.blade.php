    ...
    <form
        ...
        <form>
            <div class="form-group">
                ...
                <input type="hidden"
                       id="counterparty_id" name="counterparty_id" value="{{$counterpartyNote->counterparty_id}}">
                <input type="text"
                       id="input-counterparty" name="counterparty" value="{{$counterpartyNote->counterparty->name}}" disabled>
            </div>
            ...
            <a class="btn btn-secondary"
               href="{{route('admin.counterpartySummary',['counterparty'=>$counterpartyNote->counterparty_id, 'page' => 'notes'])}}">
                Отмена
            </a>

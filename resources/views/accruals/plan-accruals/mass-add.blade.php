...
@section('title', 'Создать серию платежей')

@section('content')
<div class="container">
    <h1 class="mb-4">Создать серию повторяющихся плановых платежей</h1>
    ...
    <form method="POST">
        ...
        <div class="form-group mb-3">
            ...
            <input 
                ...
                step="1" 
                id="repeat_count" 
                class="form-control @error('repeat_count') is-invalid @enderror" 
                name="repeat_count" 
                value="{{ old('repeat_count', $repeat_count ?? 2) }}">
            @include('partials.error', ['field' => 'repeat_count'])
        </div>

    ...
    <form method="POST" enctype="multipart/form-data" 
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                {{-- Новые поля, относящиеся к начислению --}}
                ...
                <div v-show="form.has_accrual" class="bg-white p-3">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="inputDateOpen"
                            name="accrual_date_open" v-model="form.accrual_date_open">
                    </div> 
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        ...
                        <a class="btn btn-secondary ms-2" href="{{ route('import.adesk.payments.index') }}">Отмена</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                data() {
                    return {
                        form: {
                            ...
                            accrual_date_open: @json($model->accrual_date_open),

...
@section('content')
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <a class="btn btn-secondary" href="{{ session('previous_url', route('agreementSummary', ['agreement' => $agreement, 'page' => 'documents'])) }}">
            Отмена
        </a>
    </form>
@endsection
